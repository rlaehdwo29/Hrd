...
public class SupportActivity extends IntentModelActivity {
	Cursor cursor;
	String uid,_url;
	WebView mWebView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		self=this;
		Intent i=getIntent();
		View viewToLoad = LayoutInflater.from(this.getParent()).inflate(R.layout.wview, null); //탭내 웹뷰의 <select>활성화를 위해
		...
		_url=Constants.baseUrl+Constants.supportUrl;
