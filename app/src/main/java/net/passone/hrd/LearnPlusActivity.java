...
public class LearnPlusActivity extends IntentModelActivity {
	Cursor cursor;
	String uid,_url;
	WebView mWebView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_url=Constants.baseUrl+Constants.learnplusUrl;
...
//					view.stopLoading();
	...
	private class AndroidBridge {
		...
		@JavascriptInterface
		public void goVideo(final String arg, final String title) { // must be final
			handler.post(new Runnable() {
				public void run() {
					Log.d("passone", "setMessage("+arg+")");
