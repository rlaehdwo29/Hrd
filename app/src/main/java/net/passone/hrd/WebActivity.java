...
public class WebActivity extends IntentModelActivity {
	Cursor cursor;
	String uid,_url;
	WebView mWebView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(bundle!=null)
		{
			...
			{
				_url=Constants.baseUrl+ bundle.getString("url");
			}
		}
...
//					view.stopLoading();
		...
		public void callAndroid(final String arg) { // must be final
			handler.post(new Runnable() {
				public void run() {
					...
					{
						finish();
						((Activity)context).startActivity(new Intent(self,MainActivity.class));
	...
	{
//		XActivityGroup parent = ((XActivityGroup)context);
//		parent.group.back();
